...
class custom_loss():
    ...
    def __call__(self, true_y, pred_y):
        ...
        scale = tf.tile(tf.convert_to_tensor([[[[1., 1., 1., 1./7., 1000.]]]]), loss.shape[0:-1] + [1])
...
true_x_low_complex = bio.convert_high_complex_to_low_complex_states(x_high_complex, args.args_eval_lf)

true_x0_low_complex = lambda t: true_x_low_complex[0, ]
...
val_true_x_low_complex = bio.convert_high_complex_to_low_complex_states(val_x_high_complex, args.args_eval_lf)
